 ...
 * @property ProgramaImagen[] $programaImagens
...
class Programa extends CActiveRecord
{
	...
	public function rules()
	{
        ...
        return array(
            ...
            array('precio_desde, programa_tipo_id, orden, activo, destacado, chd2', 'numerical', 'integerOnly'=>true),
            array('nombre, pdf', 'length', 'max'=>100),
            array('fecha_creacion, fecha_modificacion', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, nombre, precio_desde, descripcion, programa_tipo_id, orden, activo, destacado, fecha_creacion, fecha_modificacion, pdf, chd2', 'safe', 'on'=>'search'),
        );
	}
	...
	public function relations()
	{
		...
		return array(
            ...
            'ciudad' => array(self::BELONGS_TO, 'ProgramaHasCiudad', 'id'),
			...
			'programaImagens' => array(self::HAS_MANY, 'ProgramaImagen', 'programa_id'),
			...
			'ciudads' => array(self::HAS_MANY, 'ProgramaHasCiudad', 'programa_id'),
		);
	}

    public function getImagenDestacado(){
		
		$foto = array();
			
		foreach($this->programaImagens as $imagen){
			$foto[] = $imagen;
		}
		...
		if(count($foto) > 0){
			...
			return 'programa/'.$foto[$imagen]->imagen;
		}else{
			return 'error/image-not-found.png';
		}

        //return (isset($this->programaImagens[0]->imagen))?'programa/'.$this->programaImagens[0]->imagen:'error/image-not-found.png';
