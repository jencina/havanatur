	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Equipo']))
		{
            ...
            if(isset($uploadedFile->name)){
                ...
                if(file_exists(Yii::app()->basePath.'/../images/equipo/'.$fileName)){
                    $ran=rand(100,999);
            ...
            if($model->validate()){
                if($model->save()){
                    if(!empty($model->foto)):
                        $uploadedFile->saveAs(Yii::app()->basePath.'/../images/equipo/'.$fileName);
                    endif;
		...
		if(isset($_POST['Equipo']))
		{
            ...
            if($model->validate()){
                if($model->save()){
                    if(isset($uploadedFile->name)):
                        $uploadedFile->saveAs(Yii::app()->basePath.'/../images/equipo/'.$fileName);
                        if(file_exists(Yii::app()->basePath.'/../images/equipo/'.$foto) && !is_dir(file_exists(Yii::app()->basePath.'/../images/equipo/'.$foto))){
                            if($foto != ''){
                                unlink(Yii::app()->basePath.'/../images/equipo/'.$foto);
                            }
                        }
                    endif;
